...
public class AliSmsCodeSender {
    ...
    @Value("${aliyun.sms.vcode.singName}")
    String singName;
    @Value("${aliyun.sms.vcode.templateCode}")
    String templateCode;
    ...
    public QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("13824865025");
        //可选-流水号
    ...
    /*public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
        SendSmsResponse response = sendSms("13824865025");
